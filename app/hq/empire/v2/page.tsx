...
export default async function EmpireV2Page() {
  ...
  return (
    <div className="p-8 max-w-7xl">
      <div className="mb-8">
        ...
        <h1 className="text-4xl font-bold mb-2">👑 Empire Score V2</h1>
        <p className="text-gray-400 max-w-2xl">
          Multi-engine empire health — portfolio, revenue, execution, department
          performance, agent XP, scout XP, and venture diversification. V1
          unchanged. Advisory only.
        </p>
        <p className="text-xs text-gray-500 mt-2">
          V1: {empire.empireScoreV1} ·{" "}
